                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-products">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_modifications" id="input-modifications" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_create_product_option" id="input-create_product_option" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_create_option" id="input-create_option" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab-category">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_category_link" id="input-category_link" class="form-control">
                        ...
                        <div class="tab-pane" id="tab-orders">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="ms_integration_ms_agent" id="input-ms-agent" class="form-control">
                                        <option value=""></option>
                                        <option disabled><?php echo $text_agent_create ?> - <?php echo $help_disabled; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_reserve" id="input-reserve" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_ms_vatE" id="input-vatE" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_order_link" id="input-order_link" class="form-control">
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select disabled name="ms_integration_old_order_create" id="input-old_order_create" class="form-control">
                                        <option value="0"><?php echo $text_disabled; ?></option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab-import">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button id="link-btn" class="btn btn-primary" type="submit" form="form-ms_integration_link_product"><?php echo $import_text; ?></button>
                                </div>
                                <div class="col-sm-8">
                                ...
                                <div class="col-sm-2">
                                    <button id="delete-btn" class="btn btn-danger" type="submit" form="form-ms_delete_links"><?php echo $delete_text; ?></button>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button id="category-btn" class="btn btn-primary" type="submit" form="form-ms_category_link"><?php echo $category_text; ?></button>
                                </div>
                                <div class="col-sm-8">
                                ...
                                <div class="col-sm-2">
                                    <button id="delete-btn-2" class="btn btn-danger" type="submit" form="form-ms_delete_links_2"><?php echo $delete_text; ?></button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button disabled id="orders-btn" class="btn btn-primary" type="submit" form="form-ms_orders_link"><?php echo $orders_text; ?></button>
                                </div>
                                <div class="col-sm-8">
                                    <label class="control-label" style="text-align: left" for="category-btn"><?php echo $help_disabled; ?></label>
                                </div>
                                <div class="col-sm-2">
                                    <button disabled id="delete-btn-3" class="btn btn-danger" type="submit" form="form-ms_delete_links_3"><?php echo $delete_text; ?></button>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-2">
                                    <button id="repair-btn" class="btn btn-primary" type="submit" form="form-repair_db"><?php echo $repair_text; ?></button>
                                </div>
                                <div class="col-sm-8">
