	...
	public function index() {
		...
		if ($this->config->get('config_image')) {
			...
			$data['image'] = false;
                ...
                $data['store_admin_email'] = $this->config->get('config_email');
		$data['store'] = $this->config->get('config_name');
		$data['address'] = html_entity_decode($this->config->get('config_address'));
                $data['address_stock'] = html_entity_decode($this->config->get('config_address_stock'));
                $data['office_geolocation'] = $this->config->get('config_office_geolocation');
                $data['stock_geolocation'] = $this->config->get('config_stock_geolocation');
